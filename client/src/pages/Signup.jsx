...
const Signup = () => {
  ...
  return (
    <div className="w-full min-h-screen flex items-center justify-center p-6 bg-grid relative overflow-hidden">
      {/* Background Orbs */}
      <div className="absolute top-1/2 -left-20 -translate-y-1/2 w-[500px] h-[500px] bg-purple-600/10 rounded-full blur-[160px] animate-pulse"></div>
      <div className="absolute top-1/2 -right-20 -translate-y-1/2 w-[500px] h-[500px] bg-blue-600/10 rounded-full blur-[160px] animate-pulse delay-1000"></div>
      ...
      <div className="w-full max-w-[440px] glass-card p-10 md:p-12 relative z-10 animate-in fade-in zoom-in duration-1000">
        <div className="flex flex-col items-center mb-10">
          ...
          <h1 className="text-4xl md:text-5xl font-black text-white tracking-tighter text-center">Identity Hub</h1>
